...
bool WFG9::init (int nObj, int k, int l){
...
vector< double > WFG9::WFG_9_random_soln( const int k, const int l, vector<double> &spacek )
{
  ...
  for( int i = k+l-2; i >= k; i-- )
  {
    ...
    const double tmp1 = r_sum( result_sub, w  );
